...
// Below-the-fold sections — code-split so their JS only loads when needed,
// shrinking the initial bundle Home.jsx ships for first paint.
...
// ─── JSON-LD Schema (module-level, computed once — never re-created on render) ───
const ORGANIZATION_SCHEMA = {
  ...
  description:
    "NHS-approved healthcare recruitment agency based in Preston, Lancashire. We place Registered Nurses, Mental Health Nurses, Healthcare Assistants, and Support Workers across North-West England and the UK.",
...
const EMPLOYMENT_AGENCY_SCHEMA = {
  "@context": "https://schema.org",
  "@type": "EmploymentAgency",
  name: "EVS Healthcare Solution Ltd",
  alternateName: "EVS Healthcare Solutions",
  description:
    "NHS-approved healthcare recruitment agency specialising in Registered Nurses, Mental Health Nurses, Healthcare Assistants, and Support Workers across the UK.",
  url: "https://www.evshealthcare.co.uk",
  image: "https://www.evshealthcare.co.uk/og-image.jpg",
  telephone: "07466999218",
  email: "admin_1@evshealthcare.co.uk",
...
const LOCAL_BUSINESS_SCHEMA = {
  ...
  description:
    "NHS-approved healthcare recruitment agency based in Preston, Lancashire specialising in nurse and healthcare worker placement.",
  address: {
    "@type": "PostalAddress",
    streetAddress: "1a John William",
    addressLocality: "Preston",
...
// Combined once — a single <script> tag instead of four separate ones.
const COMBINED_SCHEMA = JSON.stringify([
  ORGANIZATION_SCHEMA,
  ...
  return (
    <>
      ...
      <Helmet>
        ...
        {/* Schema Markup — single combined script, computed once at module load */}
        <script type="application/ld+json">{COMBINED_SCHEMA}</script>
      </Helmet>

      {/* ─── Above-the-fold: eager, unsplit ────────────────────────────── */}
      <Hero />
      <TrustBadges />
      <Stats />
      <WhyChooseUs />
