...
//   - Disabled mouse tilt on touch devices
//   - Simplified counter animation
//   - Removed heavy CSS effects on mobile
...
// ── Hook: rAF-based counter with easeOutExpo (optimized for mobile) ─────────────
...
function useScrollParallax(speed = 0.3) {
  ...
  useEffect(() => {
    if (mobile) return; // Disable parallax on mobile
...
function StatCard({ stat, isVisible, index }) {
  ...
  return (
      ...
      style={{
        ...
        transition: mobile
          ...
          : `opacity 1.2s cubic-bezier(0.16,1,0.3,1),
             transform ${isVisible && hovered ? "0.3s ease" : "1.2s cubic-bezier(0.16,1,0.3,1)"},
    ...
    >
      {/* Gold accent sweep - simplified on mobile */}
      {!mobile && (
        <div style={{
          position: "absolute",
      ...
      {/* Mouse tilt glow - disabled on mobile */}
      {!mobile && (
        <div style={{
      ...
      {/* Glass shine - disabled on mobile */}
      {!mobile && (
        <div style={{
          position: "absolute",
          top: "50%", left: "-20%",
      ...
      <div style={{
        ...
        borderRadius: 999,
        margin: mobile ? "clamp(12px, 3vw, 16px) auto 0" : "clamp(16px, 2.5vw, 22px) auto 0",
        position: "relative", zIndex: 2,
...
export default function Stats() {
  ...
  const revealedCount = useSequentialReveal(inView, STATS.length, mobile ? 300 : 580);
  ...
  return (
    <>
      <style>{`
        ...
        /* Counter glow - disabled on mobile */
        ...
        /* Headline shimmer - simplified on mobile */
        @keyframes evsStatShimmer {
          0%   { background-position: 200% center; }
          100% { background-position: -200% center; }
        }

        /* Divider dot pulse - slower on mobile */
        ...
        /* Section padding */
        .evs-stats-section {
          padding: ${mobile ? "56px 16px 52px" : "clamp(72px, 10vh, 112px) clamp(20px, 6vw, 96px) clamp(72px, 9vh, 104px)"};
        }
      ...
      >
        ...
        {/* Parallax dot grid - disabled on mobile */}
        {!mobile && (
        ...
        {/* Decorative orbs - disabled on mobile */}
        {!mobile && (
          <>
            <div aria-hidden="true" style={{
              position: "absolute",
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: 1200, margin: "0 auto" }}>
          ...
          <div style={{
            textAlign: "center",
            marginBottom: mobile ? "clamp(32px, 6vh, 44px)" : "clamp(44px, 7vh, 72px)",
            opacity: inView ? 1 : 0,
            ...
            <div style={{
              ...
              <div style={{
                width: mobile ? 24 : 36, height: 1.5, background: "#C4972A", borderRadius: 999,
                opacity: inView ? 1 : 0,
            ...
            <h2 style={{
              ...
              <span style={{
                ...
                backgroundClip: "text",
                animation: mobile ? "none" : "evsStatShimmer 4s linear infinite",
              }}>
          ...
          {/* Section reveal divider - simplified on mobile */}
          <div style={{
            ...
            <div style={{
              ...
              animation: lineRevealed && !mobile ? "evsSlowPulse 3s ease-in-out infinite" : "none",
          ...
          {/* Bottom divider - simplified on mobile */}
          <div style={{
            marginTop: mobile ? "clamp(32px, 6vh, 40px)" : "clamp(48px, 7vh, 80px)",
            display: "flex", alignItems: "center", gap: mobile ? 12 : 18,
            opacity: inView ? 1 : 0,
